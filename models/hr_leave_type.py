...
class HolidaysType(models.Model):
    ...
    color_name = fields.Selection([
        ...
        ('ivory', 'Ivory')], string='Color in Report', required=True, default='red',
         help='This color will be used in the leave summary located in Reporting > leave by Department.')
    ...
    remaining_leaves = fields.Float(
        compute='_compute_leaves', string='Remaining Leave',
        help='Maximum leave Allowed - leave Already Taken')
    ...
    responsible_id = fields.Many2one(
        ...
        help="Choose the leave officer who will be notified to approve allocation or Leave request")
    leave_validation_type = fields.Selection([
        ('no_validation', 'No Validation'),
        ('hr', 'By leave Officer'),
        ('manager', "By Employee's Approver"),
        ('both', "By Employee's Approver and Leave Officer")
        ], default='hr', string='Leave Validation')
